...
CREATE TABLE inquiries (
  ...
  body TEXT NOT NULL,
  status ENUM('NEW','IN_PROGRESS','RESOLVED') NOT NULL DEFAULT 'IN_PROGRESS',
  resolved_at DATETIME NULL,
  resolved_by_role VARCHAR(10) NULL,
  ...
  KEY idx_inquiries_status_last (status, last_message_at),
...
CREATE TABLE purchase_orders (
  ...
  KEY idx_purchase_orders_created_supplier (created_at, supplier_id),
...
CREATE TABLE receipts (
  ...
  KEY idx_receipts_created_supplier (created_at, supplier_id),
